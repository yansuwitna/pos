          ...
          {editProduct ? (
            <form onSubmit={handleUpdate} onKeyDown={(e) => { if (e.key === 'Enter' && (e.target as HTMLElement).tagName !== 'BUTTON') e.preventDefault(); }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div className="form-group">
                  ...
                  <input type="number" min="0" value={editProduct.cost} onChange={e => setEditProduct({...editProduct, cost: e.target.value === '' ? 0 : (parseInt(e.target.value) || 0)})} onFocus={e => e.target.select()} required />
                </div>
                <div className="form-group">
                  <label>Harga Jual</label>
                  <input type="number" min="0" value={editProduct.price} onChange={e => setEditProduct({...editProduct, price: e.target.value === '' ? 0 : (parseInt(e.target.value) || 0)})} onFocus={e => e.target.select()} required />
                </div>
              </div>
              <div className="form-group">
                <label>Diskon (%)</label>
                <input type="number" min="0" max="100" value={editProduct.discountPercent || 0} onChange={e => setEditProduct({...editProduct, discountPercent: e.target.value === '' ? 0 : (parseInt(e.target.value) || 0)})} onFocus={e => e.target.select()} />
              </div>
            ...
            <form onSubmit={handleAdd} onKeyDown={(e) => { if (e.key === 'Enter' && (e.target as HTMLElement).tagName !== 'BUTTON') e.preventDefault(); }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div className="form-group">
                  <label>Harga Modal</label>
                  <input type="number" min="0" value={form.cost} onChange={e => setForm({...form, cost: e.target.value === '' ? 0 : (parseInt(e.target.value) || 0)})} onFocus={e => e.target.select()} required />
                </div>
                <div className="form-group">
                  <label>Harga Jual</label>
                  <input type="number" min="0" value={form.price} onChange={e => setForm({...form, price: e.target.value === '' ? 0 : (parseInt(e.target.value) || 0)})} onFocus={e => e.target.select()} required />
                </div>
              </div>
              <div className="form-group">
                <label>Diskon (%)</label>
                <input type="number" min="0" max="100" value={form.discountPercent || 0} onChange={e => setForm({...form, discountPercent: e.target.value === '' ? 0 : (parseInt(e.target.value) || 0)})} onFocus={e => e.target.select()} />
              </div>
